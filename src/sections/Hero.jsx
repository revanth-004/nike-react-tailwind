  ...
  return (
    ...
    >
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
        ...
        <h1 className="mt-10 font-palanquin text-[82px] max-sm:text-[72px] leading-tight font-bold ">
        ...
        <div className="flex justify-start items-start flex-wrap w-full my-10 gap-16">
